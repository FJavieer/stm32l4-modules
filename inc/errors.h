...
# define	ERROR_TIM_HAL_TIM_START_IT	(0x0002u | ERROR_MODULE_TIM)
# define	ERROR_TIM_INIT			(0x0004u | ERROR_MODULE_TIM)
# define	ERROR_TIM_STACK			(0x0008u | ERROR_MODULE_TIM)
# define	ERROR_TIM_CALLBACK_EXE		(0x0010u | ERROR_MODULE_TIM)
...
# define	ERROR_I2C_INIT			(0x0008u | ERROR_MODULE_I2C)
# define	ERROR_I2C_TRANSMIT		(0x0010u | ERROR_MODULE_I2C)
# define	ERROR_I2C_RECEIVE		(0x0020u | ERROR_MODULE_I2C)
# define	ERROR_I2C_NOT_READY		(0x0040u | ERROR_MODULE_I2C)
...
# define	ERROR_NUNCHUK_I2C_TRANSMIT	(0x0004u | ERROR_MODULE_NUNCHUK)
# define	ERROR_NUNCHUK_I2C_ASK		(0x0008u | ERROR_MODULE_NUNCHUK)
# define	ERROR_NUNCHUK_I2C_READ		(0x0008u | ERROR_MODULE_NUNCHUK)
# define	ERROR_NUNCHUK_START		(0x0010u | ERROR_MODULE_NUNCHUK)
